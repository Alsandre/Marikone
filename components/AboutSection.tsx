...
export const AboutSection = () => {
  return (
    <div className="bg-section md:py-16 py-12 w-screen mb-32 flex flex-col items-center">
      ...
      <Text variant='body' className='text-body md:w-2/6 w-screen px-4 text-center md:mt-8 mt-6'>Creative Fashion Designer from Tbilisi. I strive to create garments that
